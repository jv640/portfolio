                        ...
                        <div className="container text-center">
                            ...
                            <div className="grid row">
                                <div className="item col-lg-4 col-md-6">
                                    <div className="icon">
                                        <i className="icon-diploma">
                                            <a href={"https://www.codechef.com/users/jv640"} ><img src={require('../images/cpIcons/codechef.jpeg')} className="rounded-circle border border-dark" alt="logo" style={{ width: "50px", height: "50px" }} /></a>
                                        </i>
                                    </div>
                                ...
                                <div className="item col-lg-4 col-md-6">
                                    <div className="icon">
                                        <i className="icon-diploma">
                                            <a href={"http://codeforces.com/profile/vermajatin640"}><img src={require('../images/cpIcons/codeforces.jpg')} alt="logo" className="rounded-circle border border-dark" style={{ width: "50px", height: "50px" }} /></a>
                                        </i>
                                    </div>
                                ...
                                <div className="item col-lg-4 col-md-6">
                                    <div className="icon">
                                        <i className="icon-diploma">
                                            <a href={"https://www.hackerearth.com/@jv640"}><img src={require('../images/cpIcons/hackerearth.png')} alt="logo" className="rounded-circle border border-dark" style={{ width: "50px", height: "50px" }} /></a>
                                        </i>
                                    </div>
                                ...
                                <div className="item col-lg-4 col-md-6">
                                    <div className="icon">
                                        <i className="icon-diploma">
                                            <a href={"https://www.hackerrank.com/vermajatin640"}><img src={require('../images/cpIcons/hackerrank.jpg')} alt="logo" className="rounded-circle border border-dark" style={{ width: "50px", height: "50px" }} /></a>
                                        </i>
                                    </div>
                                    <h3 className="h5">HACKERRANK</h3>
                                </div>
                                <div className="item col-lg-4 col-md-6">
                                    <div className="icon">
                                        <i className="icon-diploma">
                                            <a href={"https://www.leetcode.com/jv640"}><img src={require('../images/cpIcons/leetcode.png')} alt="logo" className="rounded-circle border border-dark" style={{ width: "50px", height: "50px" }} /></a>
                                        </i>
                                    </div>
                                    <h3 className="h5">LEETCODE</h3>
                                </div>
                            </div>
                        </div>
                    </section>
