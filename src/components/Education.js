                        ...
                        <div className="col-lg-7 mx-auto">
                            <ul className="timeline">
                                ...
                                <li className="timeline-item bg-white rounded ml-3 p-4 shadow">
                                    ...
                                    <p className="text-small mt-2 mb-0 font-weight-light">Saraswati Vidya Mandir Kamla Nagar Agra, UP</p>
                                    <a href={"http://www.svmagra.in/"} class="badge badge-primary ">Website</a>
                                </li>
                                <li className="timeline-item bg-white rounded ml-3 p-4 shadow">
                                    <div className="timeline-arrow"></div>
